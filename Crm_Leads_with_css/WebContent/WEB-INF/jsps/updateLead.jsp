		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="css/css1/images/img-01.png" alt="IMG">
				</div>
<%@ include file = "menu.jsp" %>
				<form class="login100-form validate-form" action = "updateServlet"  method = "post">
					<span class="login100-form-title">
						Update Mobile Number
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" placeholder="Email" value = "<%=request.getAttribute("email") %>" readonly>
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="mobile" placeholder="Mobile Number" value = "<%=request.getAttribute("mobile") %>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
